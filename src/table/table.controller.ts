...
export class TableController {
  ...
  @ApiParam({
    name: 'number',
    type: 'string', // Changed to string to match Prisma model
    description: 'Stol raqami',
    example: 'A1', // Example reflects a string
  })
  @ApiResponse({
    status: 200,
  ...
  async findByNumber(@Param('number') number: string) { // Removed ParseIntPipe
